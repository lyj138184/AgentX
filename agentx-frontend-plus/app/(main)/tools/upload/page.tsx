  ...
  const onSubmit = async (values: FormValues) => {
    try {
      ...
      if (process.env.NODE_ENV === 'development') {
        ...
        formData.append("upload_url", values.uploadUrl);
        formData.append("is_office", "false");
        formData.append("labels", JSON.stringify(values.labels));
        formData.append("install_command", values.installCommand);
        ...
        // 这里需要根据实际API调整
        const response = await uploadToolWithToast(formData);
